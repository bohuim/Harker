 ...
 * @version 120928
 *          reviveHero is called by Game class when hero dies
 *          unequip method added
 *          teleport method added
 *
...
public class Person implements ThingOwner
{
     ...
     * sets maxHealth to 100, and sets health to maxHealth
     */
    ...
    /**
     * Calls unequip to unequip the current weapon/armor
     * takes out the equip from hero's items and puts it in weapon or armor slot
     * adds the equip rating to attack or defense
     * 
     * @param thing - adds given thing to list of things in the room
     */
    ...
    /**
     * if weapon or armor is not null, unequip subtracts the rating of the equip
     * then adds the equip from the weapon/armor slot the hero's items
     * 
     * @param equipment - the equip being unequiped
     */
    ...
    /**
     * teleports this person to the given room
     * and removes the scroll from this person's bag
     */
