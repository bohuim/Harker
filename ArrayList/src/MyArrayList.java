...
public class MyArrayList<E>
{
	...
	//used for checking ConcurrentModificationExceptions in iterator & listIterator
	//incremented every time the list is changed by MyArrayList
	...
	/**
	 * Method: iterator()
	 * Usage: Iterator<E> = MyArrayList.iterator();
	 * ---------------------------------------------
	...
	/**
	 * Method: listIterator()
	 * Usage: MyListIterator<E> = MyArrayList.listIterator();
	 * --------------------------------------------------------
	...
	private class MyArrayListIterator implements Iterator<E>
	{
		...
		//incremented every time iterator modifies underlying list
		private int itrChangeCount;

		/**
		 * Constructor: MyArrayListIterator()
		 * Usage: Iterator<E> it = MyArrayList.iterator();
		 * ---------------------------------------------
		 * constructor for an iterator for a MyArrayList
		 * sets listChangeCount & itrChangeCount to 0
		 * only to be created and returned by MyArrayList
		 */
		...
		/**
		 * Method: next()
		 * Usage: E nextObj = it.next();
		 * --------------------------------------------
		 * returns the next element in the list, and increases nextIndex by 1
		 * throws a ConcurrentModificationExpcetion if the list was changed by methods other than this iterator (listChangeCount does not match itrChangeCount)
	...
	private class MyArrayListListIterator implements MyListIterator<E>
    {
        ...
        /**
         * Constructor: MyArrayListListIterator()
         * Usage: MyListIterator<E> it = MyListIterator.listIterator();
         * ---------------------------------------------------------
         * constructor for an iterator for a MyArrayList
         * sets listChangeCount & itrChangeCount to 0
         * only to be created and returned by MyArrayList
        ...
        public E next()
        {   
            if (itrChangeCount != MyArrayList.this.listChangeCount)
                throw new ConcurrentModificationException("Underlying list cannot be changed by anything other than iterator methods when being iterated");
