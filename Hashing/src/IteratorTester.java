...
public class IteratorTester
{
    ...
    * 
    * ex) "add 100" adds 100 in ascending order to the set, "it" returns a new iterator </br></br>
    * 
    * All commands regarding iterator catches NullPointerException if "it" has not been called yet
    * 
