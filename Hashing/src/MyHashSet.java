 ...
 *      <li>{@code iterator()} returns an iterator for this HashSet </li>
 * </ul>
 * 
 * @author Dennis Moon
 * @version Apr 10, 2013
 ...
 *     Apr 14, 2013 - {@code MyHashSetIterator} & instance field {@code modCount} added
 */
public class MyHashSet<E>
{
	 ...
	 * 
	 * @author Dennis Moon
	 * @author Chris Fu - discussed & received algorithm help from Chris
	 * @version Apr 14, 2013
	 * 
	 * @Revision
	...
	private class MyHashSetIterator<E> implements Iterator<E>
	{
         ...
         * -------------------------------</br>
         * Returns whether more elements to iterate exist by checking {@code remaining > 0}
         * 
         * @return true if more elements remain to iterate
         */
        ...
        public E next()
        {   
            if (itMod != modCount) throw new ConcurrentModificationException();
         ...
         * -------------------------------</br>
         * Removes the element most recently returned by {@code next()} and decrements size.
         */
        public void remove()
        {
            if (itMod != modCount) throw new ConcurrentModificationException();
